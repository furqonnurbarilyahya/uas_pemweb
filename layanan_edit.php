    ...
    <section id="home">
      ...
      <div class="absolute container w-full z-10 top-32 p-4">
        <h1 class="text-4xl absolute mb-7 font-semibold left-56 underline underline-offset-2">Tambah Data Layanan</h1>
             <form action="layanan_edit_act.php" method="post" enctype="multipart/form-data" class="bg-cyan-700 shadow-md ml-96 mx-52 mt-20 rounded-lg px-8 pt-6 pb-8 mb-4 a">
          ...
          <div class="mb-4">
            ...
            <input disabled class="font-semibold text-black bg-white shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline" id="nama" type="text" name="nama_layanan" value="<?php echo $layanan['nama_layanan'] ?>">
         </div>
          <div class="mb-4">
            <label class="block text-white text-sm font-bold mb-2" for="nama">Hari</label>
            <input class="font-semibold text-black bg-white shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline" id="nama" type="text" name="hari" value="<?php echo $layanan['hari'] ?>">
         </div>
          <div class="mb-4">
            <label class="block text-white text-sm font-bold mb-2" for="nama">Jam</label>
            <input class="font-semibold text-black bg-white shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline" id="nama" type="text" name="jam" value="<?php echo $layanan['jam'] ?>">
         </div>
          <div class="mb-4">
            <label class="block text-white text-sm font-bold mb-2" for="nama">Dokter</label>
            <input class="font-semibold text-black bg-white shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline" id="nama" type="text" name="nama_dokter" value="<?php echo $layanan['nama_dokter'] ?>">
         </div>
          <div class="mb-4">
            ...
            <?php $status = $layanan['status']; ?>
                <option value="" disabled selected>Pilih Status</option>
                <option name="status" value="Buka" <?php echo ($status == 'Buka') ? "selected": "" ?>>Buka</option>
                <option name="status" value="Tutup" <?php echo ($status == 'Tutup') ? "selected": "" ?>>Tutup</option>
            </select>
         </div>
