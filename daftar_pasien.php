...
<html>
  <head>
    ...
    <title>Daftar Calon Pasien</title>
  </head>
  <body class="">
    <!-- Hero -->
    <section id="home">
      ...
      <div class="">
        <div class="bg-cyan-950 grid grid-rows-6 h-full justify-center px-5 text-md text-white z-0 text-opacity-70 top-20 items-center font-semibold py-10 fixed pb-20">
          ...
          <a href="#" class=" bg-cyan-900 hover:duration-700 hover:ease-in-out border border-white text-center hover:bg-slate-200 hover:text-black p-1 px-2 rounded-md">Calon Pasien</a>
          ...
          <a href="index.php" class="bg-red-700 border hover:bg-red-500 text-center p-1 rounded-md hover:text-black hover:duration-700 hover:ease-in-out">Keluar</a>
        </div>
        </div>

        <div class="top-32 left-44 absolute mx-10">
          <h1 class="text-4xl font-semibold underline underline-offset-8 mb-16">Daftar Calon Pasien</h1>
          <table cellpadding="10" class="table-fixed border-collapse border border-black">
            <thead>
              <tr class="bg-cyan-200">
                ...
                <th class="border border-black">Agama</th>
                <th class="border border-black">Layanan</th>
                <th class="border border-black">KTP</th>
            ...
            <?php 
              ...
              <tr class="bg-cyan-50">
                ...
                <td class="border border-black"><?php echo $d['nik']; ?></td>
                <td class="border border-black"><?php echo $d['jenis_kelamin']; ?></td>
                <td class="border border-black"><?php echo $d['tempat_lahir']; ?></td>
                <td class="border border-black"><?php echo $d['tanggal_lahir']; ?></td>
                <td class="border border-black"><?php echo $d['alamat']; ?></td>
                <td class="border border-black"><?php echo $d['no_telepon']; ?></td>
                <td class="border border-black"><?php echo $d['agama']; ?></td>
                <td class="border border-black"><?php echo $d['layanan']; ?></td>
                <td class="border border-black underline text-blue-500"><a href="foto/<?php echo $d['foto']?>">Lihat KTP</a></td>
                <td class="border border-black">
                  <a href="admin_proses.php?id=<?php echo $d['id']?>" class="bg-green-600 hover:text-black hover:bg-green-500 py-1 ml-1 px-2 text-white rounded-md">Proses</a>
                  <br>
                  <br>
                  <a href="admin_hapus.php?id=<?php echo $d['id']?>" class="bg-red-600  hover:text-black hover:bg-red-500 py-1 ml-1 px-2 text-white rounded-md">Hapus</a>
                </td>
              </tr>
				<?php
        $i++;
